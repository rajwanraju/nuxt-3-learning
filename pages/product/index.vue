<template>
  <div class="home-tab" v-show="!pending">
    <div class="container">
      <div class="row">
        <div class="col-md-4" v-for="(slide,i) in products.data" :key="i">
          <figure class="card card-product-grid card-lg">
            <nuxt-link
              ...
              data-abc="true"
              ><img
                :src="`https://erp.estorejamuna.com` + slide.feature_image"
              />
            </nuxt-link>
            ...
            <div class="bottom-wrap">
              ...
              <div class="price-wrap">
                <span class="price h5">$ {{ slide.discount_price }}</span>
                <br />
...
const { pending, data: products } = await useFetch(
  "https://erp.estorejamuna.com/api/category-product/air-conditioner"
);
</script>
<style scoped>
